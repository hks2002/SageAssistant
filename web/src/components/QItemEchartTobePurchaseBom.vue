<template>
  <q-item id="EchartTobePurchaseBom">
  </q-item>
</template>
<script>
if (process.env.DEV) {
  require('../mock/TobePurchaseBom')
}
      ...
      this.$axios.get('/Data/TobePurchaseBom?site=' + site)
        ...
        .catch((e) => {
          ...
          this.$q.notify({
            color: 'negative',
            position: 'top',
            message: 'Loading TobePurchaseBom Failed!',
        ...
        toolbox: {
          feature: {
            dataView: {
              title: 'DataView',
              optionToContent: () => {
                return jsonToTable(this.dimensions, this.data, 'Bom to be Purchase')
              }
            },
            myTool: {
              show: true,
              ...
              onclick: () => {
                ...
                jsonToExcel(this.dimensions, this.data, 'BomTobePurchase' + formattedString)
              }
            }
          }
        },
