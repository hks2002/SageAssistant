...
Mock.mock(RegExp('^(/Data/InvoiceHeaderByInvoiceNO)' + '.*'), options => {
...
Mock.mock(RegExp('^(/Data/InvoiceBodyByInvoiceNO)' + '.*'), options => {
...
Mock.mock(RegExp('^(/Data/InvoiceHeaderByFaPiao)' + '.*'), options => {
  console.debug('\u001b[35m' + '[Mocking] ', 'InvoiceHeader')
  // list = {data:[{}]}
  const list = Mock.mock({
    'data|1': [
