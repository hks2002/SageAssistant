...
Mock.mock(RegExp('^(/Data/CustomerHelper)' + '.*'), options => {
  ...
  const CodeOrName = getQueryParameter(options, 'CustomerCodeOrName')
    ...
    'data|1-10': [
      {
        ...
        CustomerName: () => { return CodeOrName + '_' + Mock.mock('@title(3, 5)') }
      }
    ]
  })
    ...
    'data|1-2': [
      {
        ...
        CustomerName0: () => { return Mock.mock('@title(3, 5)') },
        CustomerName1: () => { return Mock.mock('@title(3, 5)') },
        PostCode: /[0-9]{6}/,
        Contry: /[A-Z]{3}/,
        State: /[A-Z]{1}[a-z]{2,6}/,
        City: /[A-Z]{1}[a-z]{2,6}/,
