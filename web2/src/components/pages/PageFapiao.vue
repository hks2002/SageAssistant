        ...
        >
          ...
          <tbody>
            ...
            >
              ...
              <td
                class="text-right"
                :class="notMatchClass(NMN(ANN(InvoiceBody, index, 'AmountNoTax'), ANN(InvoiceBody, index, 'TaxRate')), S2N(item.je))"
              >
                {{S2N(item.je)}}</td>
              <td class="text-center">{{item.slv}}</td>
              <td
                class="text-right"
                :class="notMatchClass(NMN(ANN(InvoiceBody, index, 'AmountTax'), ANN(InvoiceBody, index, 'TaxRate')), S2N(item.se))"
              >
                {{S2N(item.se)}}</td>
            </tr>
          </tbody>
