...
export default defineComponent({
  ...
  setup (props, ctx) {
    ...
    const doUpdate = () => {
      ...
      axios.get('/Data/CostHistory?PnRoot=' + props.pnRoot)
        .then((response) => {
          data = response.data
          prepareData()
          setEchart()
    ...
    const prepareData = () => {
      ...
      _forEach(dataBySiteProject, (value, index, array) => {
        const o = {}
        Object.defineProperty(o, 'PurchaseSite', { enumerable: true, value: _get(value[0], 'PurchaseSite') })
        Object.defineProperty(o, 'ProjectNO', { enumerable: true, value: _get(value[0], 'ProjectNO') })
        Object.defineProperty(o, 'OrderPN', { enumerable: true, value: _get(value[0], 'OrderPN') })
        Object.defineProperty(o, 'OrderDate', { enumerable: true, value: _get(value[0], 'OrderDate') })
        Object.defineProperty(o, 'USD', { enumerable: true, value: _sumBy(value, 'USD') })
