<template>
  <q-item>
    <div id="EchartTodoDealWithOrderLine" style="height: 100%; width: 100%" />
...
const doUpdate = () => {
  ...
  axios
    .get('/Data/TobeDealWithOrderLine?Site=' + props.site)
    .then((response) => {
      data = response.data
      prepareData()
      setEchart()
  ...
  eChart.setOption(
    {
      title: {
        text:
          t('New order line without purchasing and without workorder at ') +
          props.site,
        left: 'center'
      },
