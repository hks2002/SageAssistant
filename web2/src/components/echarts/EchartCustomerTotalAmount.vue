...
export default defineComponent({
  name: 'EchartCustomerTotalAmount',
  ...
  setup (props, ctx) {
    ...
    const doUpdate = () => {
      ...
      axios.get('/Data/CustomerTotalAmount?CustomerCode=' + props.customerCode + '&DateFrom=' + props.dateFrom + '&DateTo=' + props.dateTo)
        .then((response) => {
          data = response.data
          prepareData()
          setEchart()
    ...
    watch(() => [props.customerCode, props.dateFrom, props.dateTo], ([newVal0, newVal1, newVal2], [oldVal0, oldVal1, oldVal2]) => {
