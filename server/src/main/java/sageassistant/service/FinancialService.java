 ...
 * @LastEditTime   : 2022-09-22 15:44:44
 * @FilePath       : \server\src\main\java\sageassistant\service\FinancialService.java
...
public class FinancialService {
    ...
    public List<FinancialBalance> getAccoutBalanceForAccountNOByCat(
        String Site,
        String Year,
        String Cat,
        String AccountNO
